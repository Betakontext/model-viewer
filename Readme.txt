This is a 3D model-viewer app to explore Gaussian Splattings online.
It includes WebXR / VR options, at the moment only tested with and optimised for Meta Quest 3, build with Java Script using the luma-webGL-library and based on Three.js frameworks. -> https://github.com/lumalabs/luma-web-examples
---------------
